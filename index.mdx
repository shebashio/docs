...
<CardGroup cols={2}>
  <Card title="Command Dashboard" icon="gauge" href="https://dashboard.dedzed.blacklabel.mil/">
    Launch the DEDZED Command Dashboard.
  </Card>
  <Card title="Kasm VDI" icon="desktop" href="https://kasm.dedzed.blacklabel.mil/">
  ...
  <Card title="SHREDDER" icon="shield-halved" href="https://shredder.dedzed.blacklabel.mil/">
...
<CardGroup cols={3}>
  ...
  <Card title="ezRMF" icon="scale-balanced" href="/rmf/index">
    AI-powered NIST RMF compliance with automated control mapping and eMASS export.
  </Card>
