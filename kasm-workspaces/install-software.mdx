...
<Steps>
  <Step title="Open your VDI session">
    Launch a Kasm workspace from [https://kasm.dedzed.blacklabel.mil](https://kasm.dedzed.blacklabel.mil).
  </Step>
  <Step title="Email the DEDZED team">
    Send your software request to [dedzed-tech@shebash.io](mailto:dedzed-tech@shebash.io) with details about what you need and your use case.
  </Step>
</Steps>
