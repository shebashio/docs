...
1. Navigate to [https://kasm.dedzed.dso.sh](https://kasm.dedzed.dso.sh) and click the **Ping Identity** option.
2. Sign in with your `firstname.lastname@usa.dev` account and **Use a certificate or smart card** option to login.
...
1. Log into the Kasm Virtual Desktop Infrastructure (VDI) at [https://kasm.dedzed.dso.sh](https://kasm.dedzed.dso.sh)
...
5. Input your full SSO principal name, including the domain (e.g., `username@usa.dev`)
