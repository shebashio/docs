...
4. Within the KASM workspace session, open a browser and navigate to [DEDZED Rancher Service](https://rancher.icbm.dev/).
...
2. You will be prompted to authenticate via **Ping Identity** — complete the login to authorize access to the cluster.
