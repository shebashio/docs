...
Navigate to [https://kasm.icbm.dev](https://kasm.icbm.dev) to start a new Kasm workspace session.
...
<Tip>
Watch the guided walkthrough below to see the full session creation flow.
</Tip>
