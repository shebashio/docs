...
To start, open your browser to [https://dedzed.blacklabel.mil](https://dedzed.blacklabel.mil).
...
1. Go to [dedzed.blacklabel.mil](https://dedzed.blacklabel.mil) and authenticate using your `@usa.dev` provided identity.
