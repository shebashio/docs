...
<Tip>
Watch the guided tutorial below to see the full deployment flow in action.
</Tip>

<iframe
  src="https://www.loom.com/embed/9d13314559c448d1b68ff08626a3ddae"
  width="100%"
  height="400"
  frameBorder="0"
  allow="fullscreen"
...
1. Open your browser to [https://dedzed.icbm.dev](https://dedzed.icbm.dev) and authenticate with your Ping login.
