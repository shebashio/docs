...
To start, open your browser to [https://dedzed.icbm.dev](https://dedzed.icbm.dev).
...
1. Go to [dedzed.icbm.dev](https://dedzed.icbm.dev) and authenticate using your Ping login.
...
4. Enter a valid [github.icbm.dev](https://github.icbm.dev) account for accessing the **flux** monitored **git repository**.
