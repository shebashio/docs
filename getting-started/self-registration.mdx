...
1. Open your web browser and go to [https://dedzed.icbm.dev](https://dedzed.icbm.dev). AWS Verified Access redirects you to Ping Identity for authentication.
...
1. Navigate to [https://kasm.icbm.dev](https://kasm.icbm.dev) and click the **Ping Identity** option.
...
2. Navigate to [https://kasm.icbm.dev](https://kasm.icbm.dev) and sign in with **Ping Identity**.
...
2. Open a browser within the Kasm session and navigate to [https://dedzed.icbm.dev](https://dedzed.icbm.dev).
