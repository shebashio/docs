...
1. Open your web browser and go to [https://dedzed.dedzed.blacklabel.mil](https://dedzed.dedzed.blacklabel.mil). AWS Verified Access redirects you to Ping Identity for authentication.
...
2. Open a browser within the Kasm session and navigate to [https://dedzed.dedzed.blacklabel.mil](https://dedzed.dedzed.blacklabel.mil).
