...
| **Network access** | Ability to reach [https://kasm.dedzed.blacklabel.mil](https://kasm.dedzed.blacklabel.mil). No VPN required -- [AWS Verified Access](/knowledge-base/zero-trust) handles secure connectivity. |
