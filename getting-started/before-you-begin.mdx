...
After registration, you access DEDZED resources through the Kasm VDI at [https://kasm.dedzed.blacklabel.mil](https://kasm.dedzed.blacklabel.mil). Kasm provides a browser-based virtual desktop with all the tools you need pre-installed, so there is nothing to install on your local machine.
