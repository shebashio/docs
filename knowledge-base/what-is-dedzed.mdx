...
[RMF](/rmf/index) provides a comprehensive system for managing DoD Authority to Operate (ATO) processes. It tracks NIST 800-53 Rev 5 controls, manages evidence with approval workflows, and integrates with AI through the Model Context Protocol (MCP) for compliance assistance.
...
| Governance | RMF | NIST 800-53 control tracking and ATO workflow management |
...
<CardGroup cols={2}>
  ...
  <Card title="RMF" icon="scale-balanced" href="/rmf/index">
    Risk Management Framework and ATO workflow.
  </Card>
</CardGroup>
