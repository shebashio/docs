...
| Module | Purpose |
|---|---|
| `day1` | Base cluster bootstrapping — Big Bang, Flux, cert-manager, certificates, Cilium, external-dns, external-secrets, MinIO, PostgreSQL, Reloader, Velero, Rancher, storage classes |
