...
flowchart TB
    ...
    Agent -.->|"3. internal_auth\nvalidate session"| WA1
```
...
sequenceDiagram
    ...
    Note over WAF: Validate Origin = https://kasm.icbm.dev<br/>Enforce /desktop/{uuid} path pattern<br/>Rate limit per source IP<br/>Block known bad inputs
