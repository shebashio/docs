...
<Info>
STIGMATE is an internal service accessible at [https://stigmate.dedzed.blacklabel.mil](https://stigmate.dedzed.blacklabel.mil) from within a [Kasm session](/kasm-workspaces/working-within-kasm). See [Zero trust access](/knowledge-base/zero-trust) for details on the DEDZED network access model.
</Info>
