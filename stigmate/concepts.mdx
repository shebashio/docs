...
This traceability is critical for RMF documentation. When you export a CKL from STIGMATE, the CCI mappings are included, allowing you to import the results directly as evidence in your [RMF project](/rmf/evidence).
...
<CardGroup cols={2}>
  ...
  <Card title="RMF concepts" icon="scale-balanced" href="/rmf/concepts">
